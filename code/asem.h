...
/*
 * Ce fichier est spécifique pour le TP à rendre en ASE (Architecture
 * des Systèmes d'Exploitation) en L3S5 d'informatique à l'Université de
 * Strasbourg.
 * Il ne doit en aucun cas être modifié, ni déposé dans votre rendu
 * sur Moodle.
 */
